        ...
        include: {
          ...
          user: {
            select: {
              ...
              projects: { where: { visibility: { in: ['public','community'] } }, select: { id: true } },
            },
          },
        },
      }),
      ...
      include: {
        ...
        user: {
          select: {
            ...
            projects: { where: { visibility: { in: ['public','community'] } }, select: { id:true, title:true, thumbnail:true, techStack:true, liveUrl:true, githubUrl:true } },
    ...
    const [users, total] = await Promise.all([
      prisma.user.findMany({
        ...
        select: {
          ...
          projects: { where: { visibility: { in: ['public','community'] } }, select: { id:true, title:true, thumbnail:true, techStack:true, liveUrl:true, githubUrl:true }, take: 4 },
          connectedPlatforms: { select: { platform: true } },
        },
      }),
  ...
  try {
    const user = await prisma.user.findFirst({
      ...
      select: {
        ...
        projects: { where: { visibility: { in: ['public','community'] } }, select: { id:true, title:true, thumbnail:true, description:true, techStack:true, liveUrl:true, githubUrl:true } },
        connectedPlatforms: { select: { platform: true } },

...
const PLATFORM_CONFIG = {
  ...
  credly: {
    label: 'Credly',
    network: 'direct',
    affiliateTag: process.env.CREDLY_AFFILIATE_TAG || 'skillhub',
    webhookSecret: process.env.CREDLY_WEBHOOK_SECRET || '',
    baseUrl: 'https://www.credly.com',
    affiliateUrl: () => 'https://www.credly.com/earner/earned_badges',
    commissionRate: 0,
    color: '#202b59',
  },
  microsoft: {
    ...
    network: 'direct',
    affiliateTag: process.env.MICROSOFT_AFFILIATE_TAG || 'skillhub',
    webhookSecret: process.env.MICROSOFT_WEBHOOK_SECRET || '',
    baseUrl: 'https://learn.microsoft.com',
    affiliateUrl: () => 'https://learn.microsoft.com/training/',
    commissionRate: 0,
    color: '#5e5e5e',
  },
  google: {
    ...
    network: 'direct',
    affiliateTag: process.env.GOOGLE_AFFILIATE_TAG || 'skillhub',
    webhookSecret: process.env.GOOGLE_WEBHOOK_SECRET || '',
    baseUrl: 'https://www.cloudskillsboost.google',
    affiliateUrl: () => 'https://www.cloudskillsboost.google/catalog',
    commissionRate: 0,
    color: '#4285f4',
  },
  aws: {
    label: 'AWS Training',
    network: 'direct',
    affiliateTag: process.env.AWS_AFFILIATE_TAG || 'skillhub',
    webhookSecret: process.env.AWS_WEBHOOK_SECRET || '',
    baseUrl: 'https://skillbuilder.aws',
    affiliateUrl: () => 'https://skillbuilder.aws/',
    commissionRate: 0,
    color: '#ff9900',
  },
  linkedin: {

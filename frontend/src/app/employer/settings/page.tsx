                ...
                {[
                  ...
                  return (
                    <div key={n.label} className="flex items-center justify-between py-4">
                      ...
                      <button onClick={()=>setOn(v=>!v)} className={`w-11 h-6 rounded-full relative transition-colors flex-shrink-0 border-0 cursor-pointer ${on?'bg-[#4F8EF7]':'bg-[rgba(255,255,255,0.1)]'}`}>
